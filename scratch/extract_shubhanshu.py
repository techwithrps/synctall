...
ledger_tag_start = xml_clean.find('<LEDGER NAME="SHUBHANSHU RAJ SINGH -20258BP080"')
if ledger_tag_start != -1:
    ...
    with open("/Users/twrps/Desktop/synctal/scratch/shubhanshu_extracted.xml", "w", encoding="utf-8") as out:
        out.write(ledger_xml)
    print("Found and extracted to scratch/shubhanshu_extracted.xml")
else:
    print("Could not find ledger for Shubhanshu")
